...
ActiveRecord::Schema.define(version: 20170710233514) do
  ...
  create_table "careships", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "care_receiver_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["care_receiver_id"], name: "index_careships_on_care_receiver_id"
  ...
  add_foreign_key "careships", "care_receivers"
  add_foreign_key "careships", "users"
end
